...
static uint8_t const matrixQwerty[8][12] =
{
    ...
    KEY_LEFTCONTROL, KEY_LEFT_GUI, KEY_LEFTSHIFT, KEY_FN, KEY_BACKSPACE, KEY_LEFTALT, KEY_RIGHTALT, KEY_SPACEBAR, KEY_FN, KEY_RIGHTSHIFT, KEY_RIGHT_GUI, KEY_RIGHTCONTROL
};
...
static uint8_t const matrixColemak[8][12] =
{
    ...
    KEY_LEFTCONTROL, KEY_LEFT_GUI, KEY_LEFTSHIFT, KEY_FN, KEY_SPACEBAR, KEY_LEFTALT, KEY_RIGHTALT, KEY_SPACEBAR, KEY_FN, KEY_RIGHTSHIFT, KEY_RIGHT_GUI, KEY_RIGHTCONTROL
};
...
static uint8_t const matrixNicolaF[8][12] =
{
    ...
    KEY_A, KEY_S, KEY_D, KEY_F, KEY_G, KEY_ESCAPE, KEY_APPLICATION, KEY_H, KEY_J, KEY_K, KEY_L, KEY_SEMICOLON,
    KEY_Z, KEY_X, KEY_C, KEY_V, KEY_B, KEY_TAB, KEY_ENTER, KEY_N, KEY_M, KEY_COMMA, KEY_PERIOD, KEY_SLASH,
    KEY_LEFTCONTROL, KEY_LEFT_GUI, KEY_LEFTSHIFT, KEY_FN, KEYPAD_ENTER, KEY_LEFTALT, KEY_RIGHTALT, KEY_SPACEBAR, KEY_FN, KEY_RIGHTSHIFT, KEY_RIGHT_GUI, KEY_RIGHTCONTROL
};
