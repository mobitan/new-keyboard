...
static uint8_t const matrixQwerty[8][12] =
{
    ...
    KEY_INTERNATIONAL3, KEY_1, 0, 0, 0, 0, 0, 0, 0, 0, KEY_0, KEY_LEFT_BRACKET,
    KEY_QUOTE, KEY_2, KEY_3, KEY_4, KEY_5, 0, 0, KEY_6, KEY_7, KEY_8, KEY_9, KEY_MINUS,
    KEY_Q, KEY_W, KEY_E, KEY_R, KEY_T, 0, 0, KEY_Y, KEY_U, KEY_I, KEY_O, KEY_P,
    KEY_A, KEY_S, KEY_D, KEY_F, KEY_G, KEY_RIGHT_BRACKET, KEY_NON_US_HASH, KEY_H, KEY_J, KEY_K, KEY_L, KEY_SEMICOLON,
