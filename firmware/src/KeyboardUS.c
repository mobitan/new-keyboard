...
static uint8_t const matrixQwerty[8][12] =
{
    ...
    KEY_Z, KEY_X, KEY_C, KEY_V, KEY_B, KEY_TAB, KEY_ENTER, KEY_N, KEY_M, KEY_COMMA, KEY_PERIOD, KEY_SLASH,
    KEY_LEFTCONTROL, KEY_GRAVE_ACCENT, KEY_LEFTALT, KEY_SPACEBAR, KEY_LEFTFN, KEY_LEFTSHIFT, KEY_RIGHTSHIFT, KEY_RIGHTFN, KEY_INTERNATIONAL4, KEY_BACKSPACE, KEY_DELETE, KEY_RIGHTCONTROL
};
